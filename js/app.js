...
var REVIEWS_DATA = [
  { name: 'Priya Sharma',   location: 'Ahmedabad', text: 'Lost 15 kgs in just 3 months! The team is incredibly supportive and the program was perfectly tailored to my busy lifestyle. Truly life-changing!', img: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop' },
  { name: 'Rahul Patel',    location: 'Gota',      text: 'Amazing inch loss results — 4 inches off my waist in just 6 weeks. Best wellness centre in Ahmedabad, absolutely no question. Highly recommend!', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop' },
  { name: 'Sneha Desai',    location: 'Ahmedabad', text: "Shilpa's nutrition plan completely changed my relationship with food. I don't feel like I'm on a diet at all, yet the results are truly remarkable.", img: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=100&h=100&fit=crop' },
  { name: 'Amit Shah',      location: 'Sarkhej',   text: "Professional, results-driven, and genuinely caring. Lost stubborn belly fat I'd had for years. Wish I'd found Fit & Shine sooner.", img: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&h=100&fit=crop' },
  { name: 'Pooja Mehta',    location: 'Ahmedabad', text: 'The post-pregnancy program was exactly what I needed — so safe and gentle, yet the results have been absolutely incredible. Thank you!', img: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop' },
  { name: 'Karan Trivedi',  location: 'Gota',      text: "Completed the 21-day detox. Honestly life-changing — my energy is through the roof, skin is glowing, and I've lost 8 kgs. Highly recommended!", img: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop' }
];
